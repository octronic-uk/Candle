...
const QString Settings::GFX_GRAYSCALE = "Grayscale";
const QString Settings::GFX_GRAYSCALE_S_CODE = "GrayscaleSCode";
const QString Settings::GFX_GRAYSCALE_Z_CODE = "GrayscaleZCode";
...
// User Command
const QString Settings::USER_COMMAND = "UserCommand";
const QString Settings::USER_COMMAND_1 = "UserCommand1";
const QString Settings::USER_COMMAND_2 = "UserCommand2";
const QString Settings::USER_COMMAND_3 = "UserCommand3";
const QString Settings::USER_COMMAND_4 = "UserCommand4";
